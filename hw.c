...
extern unsigned char conin_buffer[30];
extern unsigned char conin_buffer_pointer;
...
{
//if (U3ASTAbits.URXDA==1) return 0xFF;
//	else return 0x00;
if (conin_buffer_pointer>0) return 0xFF;
	else return 0;
...
{
unsigned char temp;
temp = conin_buffer[conin_buffer_pointer-1];
